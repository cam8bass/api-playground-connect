...
export interface notificationMessageInterface {
  NOTIFICATION_ADMIN_DELETE_ALL_USER_APIKEYS: string;
  NOTIFICATION_SUCCESS_ADMIN_DELETE_USER: string;
  NOTIFICATION_ADMIN_CREATE_NEW_USER: string;
  NOTIFICATION_ADMIN_CREATE_NEW_API_KEY: string;
  NOTIFICATION_SUCCESS_ADMIN_CREATE_NEW_API_KEY: string;
  NOTIFICATION_ADMIN_REFUSE_API_KEY_CREATION: string;
  NOTIFICATION_ADMIN_ACCEPT_API_KEY_CREATION: string;
